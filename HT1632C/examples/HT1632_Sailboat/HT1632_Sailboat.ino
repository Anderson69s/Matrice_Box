...
void loop () {
  ...
  HT1632.drawImage(IMG_SAILBOAT, IMG_SAILBOAT_WIDTH,  IMG_SAILBOAT_HEIGHT, i, 4);
  // If the image intersects with the end,
  if (i > OUT_SIZE - IMG_SAILBOAT_WIDTH) {
    // Draw it wrapping around.
    HT1632.drawImage(IMG_SAILBOAT, IMG_SAILBOAT_WIDTH,  IMG_SAILBOAT_HEIGHT, i - OUT_SIZE, 4);
  }
