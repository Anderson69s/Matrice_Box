...
void loop () {
  ...
  if (digitalRead(8) == HIGH) {// Si notre bouton est en position HIGH.
    ...
    HT1632.drawText("DISPO", 4, 4, FONT_8X4, FONT_8X4_END, FONT_8X4_HEIGHT);// On écrit "DISPO" avec pour origine x et y : 4. On assigne la font de taille 8.
  ...
  if (digitalRead(8) == LOW) { // Si notre bouton est en position LOW.
    ...
    HT1632.drawText("OCCUPE", 1, 4, FONT_8X4, FONT_8X4_END, FONT_8X4_HEIGHT);// On écrit "Occupé" avec pour origine x et y : 4. On assigne la font de taille 8.
    HT1632.render();// On envoie le tout à la matrice
  }
}
