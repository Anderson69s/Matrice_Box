...
void loop () {
  ...
  HT1632.drawImage(IMG_SAILBOAT, IMG_SAILBOAT_WIDTH,  IMG_SAILBOAT_HEIGHT, i, 4);//On dessine notre bateau
  if (i > OUT_SIZE - IMG_SAILBOAT_WIDTH) {// Si l'image rencontre le bord de la matrice
    HT1632.drawImage(IMG_SAILBOAT, IMG_SAILBOAT_WIDTH,  IMG_SAILBOAT_HEIGHT, i - OUT_SIZE, 4);//On dessine notre bateau dans l'autre sens.
  }
